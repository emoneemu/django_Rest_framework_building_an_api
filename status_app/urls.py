...
from .views import StatusAPIView,StatusListAPIView,StatusCreateAPIView,StatusDetailAPIView,StatusUpdateAPIView,StatusDeleteAPIView
...
urlpatterns =[
    ...
    path("status/details/<id>/",StatusDetailAPIView.as_view()),
